...
const requiredColumns = new Set([
  ...
  "TreeEntitlement.treeId",
  "TreeEntitlement.tier",
  "TreeEntitlement.maxPeople",
  "TreeEntitlement.maxVerifiedMembers",
  "TreeEntitlement.storageQuotaBytes",
  "TreeEntitlement.contributionLinksPerMonth",
  "TreeEntitlement.snapshotLimit",
  "TreeEntitlement.studioVideoAllowed",
  ...
  "MediaAsset.consentStatus",
  "MediaUploadReservation.treeId",
  "MediaUploadReservation.userId",
  "MediaUploadReservation.storageKey",
  "MediaUploadReservation.sizeBytes",
  "MediaUploadReservation.expiresAt",
  "MediaUploadReservation.consumedAt",
  "StoryAsset.storyId",
  "StoryAsset.mediaAssetId",
  "StoryAsset.role",
  "ContributionRequest.treeId",
  "ContributionRequest.prompt",
  "ContributionRequest.tokenHash",
  "ContributionRequest.expiresAt",
  "ContributionRequest.usedAt",
  "ContributionRequest.status",
  "ContributionProposal.treeId",
  "ContributionProposal.kind",
  "ContributionProposal.payload",
  "ContributionProposal.status",
  "TreeAuditEvent.treeId",
  "TreeAuditEvent.action",
  "TreeAuditEvent.entityType",
  "TreeAuditEvent.metadata",
  "StudioLead.userId",
  "StudioLead.packageInterest",
  "StudioLead.consentAt",
  "StudioLead.status",
  "StudioDeliverable.treeId",
  "StudioDeliverable.uploadedById",
  "StudioDeliverable.kind",
  "StudioDeliverable.storageKey",
  "StudioDeliverable.mimeType",
  "StudioDeliverable.sizeBytes",
]);
